...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = UIColor (
            red: 235/255, green: 75/255, blue: 27/255, alpha: 1.0)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "csie.CoreDataDemo" in the application's documents Application Support directory.
